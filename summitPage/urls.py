...
urlpatterns = [
    ...
    path(
        ...
        views.edit_registrant,
        name="edit_registrant",
    ),
    path(
        "registrant/<int:registrant_id>/edit/modal/",
        views.edit_registrant_modal,
        name="edit_registrant_modal",
    ),
    path(
        "edit-exhibitor/<uuid:exhibitor_id>/",
        views.edit_exhibitor_modal,
        name="edit_exhibitor_modal",
    ),
    path("approve/<uuid:exhibitor_id>/", approve_exhibitor, name="approve_exhibitor"),
    path("approved/", approved_exhibitors, name="approved_exhibitors"),  # urls.py
    path(
        "ajax/approve/<uuid:exhibitor_id>/",
        ajax_approve_exhibitor,
        name="ajax_approve_exhibitor",
    ),
    # category setup
    ...
    path("cyber_drill/", views.cyber_drill, name="cyber_drill"),
    ...
    path("export/print/exhibitors/", views.export_print_exhibitors, name="export_print_exhibitors"),
    path("export/print/approved/", views.export_print_approved, name="export_print_approved"),
    ...
    path(
        "badge/<uuid:exhibitor_id>/",
        views.generate_exhibitor_badge,
        name="generate_exhibitor_badge",
    ),
    path(
        "resend-email/<uuid:exhibitor_id>",
        views.resend_exhibitor_confirmation_email,
    ...
    path(
        "resend-email/<int:registrant_id>/",
        views.resend_confirmation_email,
        name="resend_confirmation_email",
    ),
    path(
        "approve-student/<int:registrant_id>/",
    ...
    path(
        "dashboard/speakers/<uuid:pk>/edit/",
        views.update_speaker,
        name="update_speaker",
    ),
    path(
        "dashboard/speakers/<uuid:pk>/delete/",
        views.delete_speaker,
        name="delete_speaker",
    ),
    # PARTNERS
    ...
    path(
        "partners/delete/<uuid:partner_id>/",
        views.delete_partner,
        name="delete_partner",
    ),
    # GALLERY
    ...
    path(
        "admin-dashboard/exhibitors/delete/<uuid:pk>/",
        views.admin_exhibitor_delete,
        name="admin_exhibitor_delete",
    ),
    # --- Sections management ---
    ...
    path(
        "admin-dashboard/sections/<int:pk>/edit/",
        views.admin_edit_section,
        name="admin_edit_section",
    ),
    path(
        "admin-dashboard/sections/<int:pk>/delete/",
        views.admin_delete_section,
        name="admin_delete_section",
    ),
    # --- Booths management ---
    ...
    path(
        "admin-dashboard/booths/<int:pk>/edit/",
        views.admin_edit_booth,
        name="admin_edit_booth",
    ),
    path(
        "admin-dashboard/booths/<int:pk>/delete/",
        views.admin_delete_booth,
        name="delete_booth",
    ),
    # --- sponsor management ---
    path(
        "sponsor/register/",
        views.summit_sponsor_registration,
        name="summit_sponsor_registration",
    ),
    path("admin/sponsors/", views.sponsor_dashboard, name="sponsor_dashboard"),
    path(
        "admin/sponsors/delete/<uuid:sponsor_id>/",
        views.delete_sponsor,
        name="delete_sponsor",
    ),
    # --- audit & trails ---
